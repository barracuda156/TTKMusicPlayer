    ...
    : QObject(parent)
{
    ...
    constexpr Qmmp::AudioFormat default_format = Qmmp::PCM_S16LE;
#else
    constexpr Qmmp::AudioFormat default_format = Qmmp::PCM_S16BE;
#endif
    m_aud_format = static_cast<Qmmp::AudioFormat>(settings.value("Output/format", default_format).toInt());
